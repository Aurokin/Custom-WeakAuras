...
aura_env.kickOrder[1]["Auro"] = true;
aura_env.kickOrder[1]["Skyline"] = true;
aura_env.kickOrder[2]["Frippers"] = true;
aura_env.kickOrder[2]["Procz"] = true;
aura_env.kickOrder[3]["Tenkiei"] = true;
